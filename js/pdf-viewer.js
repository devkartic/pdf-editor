...
var PDFMiniViewers = (function () {
    ...
    var ICON = {
        ...
        download: '<button style="background: white;border-radius: 5px;"><div style="padding: 5px 15px;font-size:16px;font-weight: 500;color:black!important;">Submit</div></button>',
...
function send_pdf_to_server(blob) {
    var formData = new FormData();
    const blobFile = new File([blob], 'advanced-psychological-assessment.pdf');
    formData.append("advanced_psychological_assessment", blobFile);
    $.ajax({
        // url: "/wp-content/themes/kallyas-child/pdf-editor/apply.php",
        // url: "/pdf-editor/apply.php",
        type: 'post',
        data: formData,
        processData: false,
        contentType: false,
